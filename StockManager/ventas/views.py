...
from ventas.models import Proveedor, Producto, Categoria, Venta, Cliente
from rest_framework import viewsets, permissions
from .serializers import ProveedorSerializer, ProductoSerializer, CategoriaSerializer, VentaSerializer, ClienteSerializer
